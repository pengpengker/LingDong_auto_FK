<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\MaLong\item\faka\application\templates\pc\merchant\default\goods_coupon\add.html";i:1539744090;s:71:"F:\MaLong\item\faka\application\templates\pc\merchant\default\base.html";i:1539744041;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
		...
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
						<label class="col-md-2 control-label">折扣类型</label>
						<div class="col-md-4">
							...
							<div class="radio radio-primary radio-inline">
                                <input type="radio" name="type" id="type2" value="100">
                                <label for="type2">
                                    %
                                </label>
                            </div>
						...
						<div class="col-md-6">
							<p class="form-control-static">批发的商户请选择“百分比”的折扣面额，单商品的建议选择“元”的面额。</p>
						</div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select name="expire_day" class="form-control" class="yxq">
