<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\MaLong\item\faka\application\templates\pc\shop\geren\\index.html";i:1539744031;s:67:"F:\MaLong\item\faka\application\templates\pc\shop\geren\layout.html";i:1545137017;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link href="/static/app/theme/geren/css/reset.css" rel="stylesheet" type="text/css">
    <link href="/static/app/theme/geren/css/style.css" rel="stylesheet" type="text/css">
    ...
    <script src="/static/app/theme/geren/js/jquery-1.7.2.min.js"></script>
    <script src="/static/app/js/nyro.js"></script>
    <script src="/static/app/js/woodyapp.js?_v=<?php echo date('YmdHi'); ?>"></script>
    <link rel="stylesheet" href="/static/app/theme/geren/css/iziToast.min.css">
    <script src="/static/app/js/layer.js"></script>
    <script src="/static/app/theme/geren/js/iziToast.min.js"></script>
    <script>
...
<form name="p" method="post" action="/pay/order" onsubmit="return checkform2();" target="_blank" class="nyroModal">
    <div class="wrapper choose-wrap">

        <div class="choose">
            <div class="choose-title">选择商品/CHOOSE GOODS</div>
	...
	<div class="choose-rigt">
		    ...
		    <option value="">请选择商品</option>
                ...
                <div class="choose-item">
                    ...
                    <div class="choose-rigt">
                        ...
                        <span class="choose-item-t choose_email"><label class="lab1"><input type="checkbox" name="isemail"
                                                                                            value="1" id="email" onclick="checkis_email2()">邮箱提醒[免费]</label></span>
                    </div>
                </div>
        ...
        <div class="choose-info">
            <div class="choose-info-item">
                <h3 class="choose-info-tit"><span>系统公告：</span></h3>
                <div id="notice" class="choose-info-desc">
                    <?php echo $shop['shop_notice']; ?>
                </div>
            </div>
            <div class="choose-info-item">
                <h3 class="choose-info-tit"><span>我的信息：</span></h3>
                <div class="choose-info-desc choose-info-desc1">
                    店铺名称：<?php echo $shop['shop_name']; ?><br>
                    卖家网站：<a href="<?php echo $shop['website']; ?>" target="_blank">点击浏览</a><br />
                    商品类型： 数字卡密<br>
                    发货类型： 自动发货<br>
                    卖家Q Q： <a href="//wpa.qq.com/msgrd?v=1&uin=<?php echo $shop['qq']; ?>&site=miaoka.la&menu=yes'" target="_blank"><?php echo $shop['qq']; ?></a>
                </div>
            </div>
            <div class="choose-qr">
                <div class="choose-qr-img">
