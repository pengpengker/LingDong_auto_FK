<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\MaLong\item\faka\application\templates\pc\merchant\default\spread\rebate.html";i:1539744088;s:71:"F:\MaLong\item\faka\application\templates\pc\merchant\default\base.html";i:1585486427;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<div class="col-sm-12">
					分成比例：<?php echo get_spread_rebate_rate()*100; ?>% | 已返利总额：<?php echo $_user->rebate; ?>元
				</div>
			</div>
			<!-- end row -->
			<div class="row">
