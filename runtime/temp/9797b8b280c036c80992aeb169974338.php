<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\MaLong\item\faka\application\templates\pc\shop\chiji\\index.html";i:1539744033;s:67:"F:\MaLong\item\faka\application\templates\pc\shop\chiji\layout.html";i:1545137017;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link href="/static/app/theme/chiji/css/reset.css" rel="stylesheet" type="text/css">
    <link href="/static/app/theme/chiji/css/style.css" rel="stylesheet" type="text/css">
    ...
    <script src="/static/app/theme/chiji/js/jquery-1.7.2.min.js"></script>
    <script src="/static/app/js/nyro.js"></script>
    <script src="/static/app/js/woodyapp.js?_v=<?php echo date('YmdHi'); ?>"></script>
    <link rel="stylesheet" href="/static/app/theme/chiji/css/iziToast.min.css">
    <script src="/static/app/js/layer.js"></script>
    <script src="/static/app/theme/chiji/js/iziToast.min.js"></script>
    <script>
...
<div class="header">
    <div class="wrapper">
        <div class="header-logo">
            <a href="/"><img src="<?php echo sysconf('merchant_logo'); ?>" alt=""></a>
        </div>
...
<div class="banner">
    <div class="wrapper">
        <div class="banner-txt">
            <div class="banner-txt-hd"><img src="/static/app/theme/chiji/imgs/txt1.png" /></div>
    ...
    <div class="saler">
        <div class="wrapper">
            <div class="saler-wrap">
                <div class="saler-head"><img src="/static/app/theme/chiji/imgs/txt2.png" /></div>
                <div class="saler-body">
                    <div class="saler-body-txt">
                        <?php echo $shop['shop_name']; ?><br>卖家网站：<a href="<?php echo $shop['website']; ?>" target="_blank" style="color:white;">点击浏览</a><br />商品类型：
                        数字卡密<br>发货类型： 自动发货<br> 卖家Q Q：<a href="//wpa.qq.com/msgrd?v=1&uin=<?php echo $shop['qq']; ?>&site=miaoka.la&menu=yes'"
                                                        target="_blank" style="color:white;"><?php echo $shop['qq']; ?></a>
                    </div>
    ...
    <div class="choose">
        <div class="wrapper">
            <div class="choose-wrap">
                <div class="choose-title"><img src="/static/app/theme/chiji/imgs/txt3.png" /></div>
                    ...
                    <div class="choose-item">
                        ...
                        <div class="choose-rigt">
                                <span class="choose-item-t choose_sms"><label class="lab1"><input type="checkbox" name="is_rev_sms"
                                                                                                  value="1" id="is_rev_sms" onclick="checkis_rev_sms2()" data-cost="<?php if(isset($goods) && $goods['sms_payer']==1): ?>0<?php else: ?><?php echo get_sms_cost(); endif; ?>">短信提醒[<?php if(isset($goods) && $goods['sms_payer']==1): ?>商家赠送<?php else: ?>收费<?php echo get_sms_cost(); ?>元<?php endif; ?>]</label></span>
                    ...
                    <div class="choose-item" id="goodCoupon" style="display: none;">
                        ...
                        <div class="choose-rigt">
                            <input type="text" name="couponcode" placeholder="请填写你的优惠券" onblur="checkCoupon2()"
                                ...
                                src="/static/app/images/load.gif"> 正在查询...</span>
                        </div>
                    </div>
        ...
        <div class="wrapper">
            <div class="paytype-wrap">
                <div class="paytype-head">
                    <img src="/static/app/theme/chiji/imgs/txt4.png" />
                </div>
                ...
                <div class="paytype-body">
                    ...
                    <!--<?php if($v['status']==1): ?>-->
                    <label for="pay_item_<?php echo $v['channel_id']; ?>" class="paytype-item <?php if($n==0): ?>on<?php endif; ?>" data-pid="<?php echo $v['channel_id']; ?>">
                        <div style="background: white;">
                            <label>
                                <input id="pay_item_<?php echo $v['channel_id']; ?>" name="pid" style="display:none;border:0;" onclick="javascript:setFeeRate('<?php echo $v['rate']; ?>')"
                                       value="<?php echo $v['channel_id']; ?>" type="radio">
...
<div class="footer"><?php echo sysconf('site_info_copyright'); ?></div>
<script>
    //邮箱显示
