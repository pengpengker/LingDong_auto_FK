<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\MaLong\item\faka\application\templates\pc\shop\default\\category.html";i:1538286655;s:78:"F:\MaLong\item\faka\application\templates\pc\shop\default\category_layout.html";i:1538306118;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<li>
    ...
    <p class="big_txt" title="<?php echo $category['name']; ?>" style="padding: 5px 10px;color: #666;"><?php echo $category['name']; ?></p>
    <script>
        $(function () {
            selectcateid();
        })
...
<li>
            ...
            <div class="pay_box">
                ...
                <div class="pay_list1">
                    <!-- <?php echo $n=0; ?> -->
                    <!-- <?php echo $sub_n=0; ?> -->
                    <?php foreach($userChannels as $v): if($v['status']==1): ?>
                    <label class="lab3 <?php if($n==0): ?>checked2<?php endif; ?>">
                        <input name="pid" value="<?php echo $v['channel_id']; ?>" data-bank="" type="radio" <?php if($n==0): ?>checked<?php endif; ?>>
